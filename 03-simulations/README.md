...
3. На 1 000 итерациях сравнены группы с помощью χ², t-теста Уэлча, U-теста Манна — Уитни и bootstrap.
...
2. На каждой итерации заново сгенерированы ответы в обеих группах: конверсия 10% в контроле и 11% в тесте.
3. Группы сравнены с помощью тех же четырёх методов.
4. Мощность оценена как доля итераций с `p-value < 0.05` по 1 000 симуляций для каждого размера выборки.
5. Проверена зависимость мощности от общего количества пользователей: 1 000, 5 000, 20 000, 30 000 и 40 000.
