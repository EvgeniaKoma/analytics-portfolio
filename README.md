...
| [03. Симуляции A/A и A/B тестов](03-simulations/) | Проверка сплитования, распределений p-value и мощности статистических критериев. | [Ноутбук](03-simulations/analysis.ipynb) |
| [04. Анализ CTR четырьмя методами](04-ratio-metrics/) | Расчёт объёма выборки и оценка A/B-теста: дельта-метод, линеаризация, бутстрап и бакетизация. | [Ноутбук](04-ratio-metrics/analysis.ipynb) |
