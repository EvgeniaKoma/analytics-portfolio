...
| [04. Анализ CTR](04-ratio-metrics/) | Расчёт объёма выборки и оценка A/B-теста: дельта-метод, линеаризация, бутстрап и бакетизация. | [Ноутбук](04-ratio-metrics/analysis.ipynb) |
